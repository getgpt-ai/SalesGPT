...
def load_openai_key():
    """
    Load OpenAI API key from .env file and set it in the environment.
    """
...
def main():
    """
    Main function to run the sales conversation program.
    """
    load_openai_key()

    # Initialize argparse
    parser = argparse.ArgumentParser(description='Sales Conversation Program')
